...
export default class BlackBox extends Component {
  ...
  render () {
    ...
    const { network, user, router, auth } = this.props
    const { form } = this.state
    const routerCopy = JSON.parse(JSON.stringify(router))
    delete routerCopy.events
    ...
    return (<div className="bb bg-light">
      ...
      <div className="container">
        ...
        <div className="d-flex justify-content-center align-self-stretch">
          <div className="box"><pre>url : {JSON.stringify(routerCopy, null, 4)}</pre></div>
