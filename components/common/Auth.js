...
export default class Auth extends Component {
  ...
  componentDidMount() {
    const { authed, router, setToken, server, serverError } = this.props
    const { query } = router
    ...
    return (<div className="container">
      ...
      <div className="mx-auto col-12 col-md-5 col-lg-3 mt-lg-5 pt-lg-5">
        ...
        { step == 1 && <div className="">
          ...
          <div className="text-light text-center my-5"><small>8333 is a passwordless service. Click the magic link received by email to {action} !</small></div>
        </div>}
